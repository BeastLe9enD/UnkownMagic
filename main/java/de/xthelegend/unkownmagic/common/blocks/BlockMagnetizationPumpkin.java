...
public class BlockMagnetizationPumpkin extends UMBlockDirectional
{
    ...
    public BlockMagnetizationPumpkin(Material material, String unlocalName,
			float hardness) {
		super(material, unlocalName, hardness);
        this.setTickRandomly(true);
        this.field_149985_a = true;
    ...
    {
        this.field_149986_M = p_149651_1_.registerIcon(this.getTextureName() + "_face_" );
